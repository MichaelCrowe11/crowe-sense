...
Subject: Crowe Sense: request to present
...
Your site says to send the deck and the pertinent information to you first, and to fill in the Dealum forms only once the fit is there. The report attached is that deck. Which meeting is the next open screening?
