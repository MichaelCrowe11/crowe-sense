...
Subject: Crowe Sense: Global Impact Challenge entry
...
I know the startup route is the application form and that the accelerator is closed at the moment. This note is so the name is familiar when the entry lands, and ten minutes to make sure I pick the right track would help.
